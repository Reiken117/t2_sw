      ...
      function info_popup(feature, layer){
        layer.bindPopup("<h1>" + feature.properties.barrio + "</h1><hr>"+"<strong> Identificación: </strong>"+feature.properties.id+"<br/>"+"<strong> Categoria: </strong>"+feature.properties.categoria+"<br/>");
    }
    ...
    var dengue_2015 = L.geoJSON();
        ...
        leyenda.addOverlay(dengue_2015, 'dengue_2015');
            }
        });
      /* contents */
